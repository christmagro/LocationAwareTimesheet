...
<h2>Add contact for ${client.clientName} </h2>

<c:url var="saveUrl" value="/client/addClientDetails?clientid=${client.id}" /> 
<form:form id="addclientdetails" modelAttribute="addclientdetails"  method="POST" action="${saveUrl}">
	<table>
		...
		<tr>
			...
			<td><form:input path="" id="contactAddress1"  name="contactAddress1"/></td>
		</tr>
		<tr>
			<td><form:label path="">Address2</form:label></td>
			<td><form:input path="" id="contactAddress2"  name="contactAddress2"/></td>
		</tr>
